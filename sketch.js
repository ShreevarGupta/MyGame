...
function setup() {
    ...
    ground30 = new Tile2(9830, 720, 230, 400);
    ...
    door = new Door(9825, 370, 250, 300);
    
    cactus1 = new Cactus(770, 400, 100, 130);
    cactus2 = new Cactus(1780, 647, 100, 130);
    //cactus3 = new Cactus();

    stone1 = new Stone(1430, 660, 170, 100);
    //stone2 = new Stone();
    //stone3 = new Stone();

    knife1 = new Knife(2530, 450, 150, 50);
...
function draw() {
    ...
    knife1.display();
    knife1.body.velocity.x = -7;
    console.log(knife1.body.velocity.x);
